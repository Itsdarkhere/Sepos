...
export default function Text({ arrayObject, languagePack, lang }) {
  ...
  const getWebsiteLink = () => {
    if (arrayObject.website !== '') {
      return (
        <a className="text-neutral-700 border-b-2 border-b-orange-400 transition duration-300 ease-in-out hover:text-gray-700 hover:border-b-orange-500" target="_blank" rel="noopener noreferrer" href={arrayObject.website}>
